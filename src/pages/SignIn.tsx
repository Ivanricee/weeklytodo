  ...
  return (
    <main className="container mx-auto bg-background flex items-center justify-center w-screen h-screen">
      <Tabs
        ...
        className="w-full xl:w-1/4 md:w-2/5 sm:w-2/4  flex flex-col rounded-3xl border-[1.7px] border-secondary/50 bg-transparent shadow-3xl p-0 "
      >
        <p className="shadow-none bg-transparent text-3xl font-bold uppercase font-rubik p-6 pb-0 text-foreground/75">
          {activeTab === 'sign-in' ? 'Sign in' : 'Register'}
        </p>
